...
- **`zendesk-attachment-downloader`**: Downloads customer config files, manifests, and agent flares from the ticket before reproducing. Uses `zd-api.sh attachments` + `curl`.
